...
abstract class $AuthStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({AuthModel authModel, bool loading});
...
class _$AuthStateImpl implements _AuthState {
  _$AuthStateImpl({required this.authModel, this.loading = false});
  ...
  @override
  String toString() {
    return 'AuthState(authModel: $authModel, loading: $loading)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, authModel, loading);
...
abstract class _AuthState implements AuthState {
  factory _AuthState({required final AuthModel authModel, final bool loading}) =
      _$AuthStateImpl;
